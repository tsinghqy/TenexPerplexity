...
Guidelines for React components, hooks, API routes, and mobile responsiveness.
...
```typescript
// ✅ Good: Descriptive component and props
...
```typescript
// ✅ Good: Extracted reusable hook with descriptive return
...
// ✅ Good: Touch-friendly button with responsive sizing
<button className="min-h-[44px] min-w-[44px] px-4 py-2 md:px-6 md:py-3">
  Send Message
</button>
```
